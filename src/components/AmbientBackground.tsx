...
export function AmbientBackground() {
  return (
    ...
    >
      ...
      <svg className="absolute -right-32 top-20 h-[28rem] w-[28rem] animate-float-slow text-foreground/[0.04]" viewBox="0 0 200 200">
        <circle cx="100" cy="100" r="95" fill="currentColor" />
        <circle cx="100" cy="100" r="70" fill="none" stroke="currentColor" strokeWidth="2" className="text-foreground/[0.06]" />
        <circle cx="100" cy="100" r="18" fill="none" stroke="currentColor" strokeWidth="6" className="text-foreground/[0.08]" />
      </svg>

      {/* Dumbbell silhouette bottom-left */}
      <svg className="absolute -left-20 bottom-40 h-72 w-[36rem] animate-float-reverse text-foreground/[0.05]" viewBox="0 0 600 200">
      ...
      <svg className="absolute right-1/4 bottom-10 h-40 w-40 animate-float-slow text-foreground/[0.05]" viewBox="0 0 200 200">
